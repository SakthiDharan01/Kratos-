          ...
          <Link href="/" className="flex items-center space-x-3">
            <div className="relative">
              <img
                ...
                alt="Hackathon Badge"
                className="w-12 h-auto filter brightness-110"
              />
            ...
            {isAuthenticated ? (
              <>
                ...
                >
                  ...
                  {cartItemsCount > 0 && (
                    <motion.span 
                      className="absolute -top-1 -right-1 bg-gradient-to-r from-pink-500 to-red-500 text-white rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
              ...
              <Link
                href="/login"
                className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white px-6 py-2 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/30"
              >
                Login
              </Link>
            )}
        ...
        <AnimatePresence>
          {isMenuOpen && (
            <motion.div
              ...
              className="md:hidden border-t border-cyan-400/30"
            >
